...
Automatically generated by HYDRA Network Scanner
        ...
        print(f"📧 Email sent for scan {scan_id} - {len(successful_101_hosts)} 101 hosts")
        return True
...
def run_scan(scan_id, hosts, protocol):
    ...
    try:
        ...
        print(f"✅ Scan {scan_id} completed: {len(successful_hosts)} successful, {len(successful_101_hosts)} with 101 Switching Protocols")
...
def start_scan():
    try:
        ...
        print(f"🚀 Started scan {scan_id} for {len(hosts)} hosts with protocol {protocol}")
